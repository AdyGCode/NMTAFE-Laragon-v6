...
|:--------------------|:------------------------------------------------------------------------------------------------------------------------|:-----------------------------|----------------------------------------------------------------------------------------------------------------------|:-----------------------------|
| **Main System**     | [Laragon](https://laragon.org)                                                                                          | 6                            | [Laragon wamp 6 Installer](https://github.com/AdyGCode/NMTAFE-Laragon-v6/releases/download/v1.0/laragon-wamp-v6.exe) |                              |
| **Main System**     | [Laragon](https://laragon.org)                                                                                          | 6                            | [Laragon ZIP](https://github.com/AdyGCode/NMTAFE-Laragon-v6/releases/download/v1.1/laragon.zip)                      |                              |
|                     |                                                                                                                         |                              |                                                                                                                      |                              |
